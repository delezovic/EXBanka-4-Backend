...
func main() {
	...
	r.DELETE("/auth/totp", middleware.RequireRole("READ", "CLIENT"), handlers.TOTPDisable(authClient))
	r.GET("/notifications", middleware.RequireRole("READ", "CLIENT"), handlers.ListNotifications(authClient))
	r.GET("/notifications/unread-count", middleware.RequireRole("READ", "CLIENT"), handlers.GetUnreadCount(authClient))
	r.PUT("/notifications/:id/read", middleware.RequireRole("READ", "CLIENT"), handlers.MarkNotificationRead(authClient))
	r.PUT("/notifications/read-all", middleware.RequireRole("READ", "CLIENT"), handlers.MarkAllNotificationsRead(authClient))
